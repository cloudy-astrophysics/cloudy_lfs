...
#if 0
// this test is unreliable, it can lead to false negatives if background tasks are running
// since this feature is not important to use, we simply disable this test
